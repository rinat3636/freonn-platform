      ...
      <CardContent className="p-6 md:p-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <div
              className={`text-5xl md:text-6xl font-black tracking-tight leading-none ${overdue ? "text-red-300" : "text-white"}`}
            >
          ...
          <div className="w-full md:max-w-xs">
            <div className="flex justify-between text-sm mb-2 text-white/75">
              <span>Готовность</span>
              <strong className="text-white">{project.progressPercent}%</strong>
            </div>
            <Progress
              value={project.progressPercent}
              className="h-3 bg-white/15 [&>div]:bg-primary"
            />
